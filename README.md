...
- `--variable, -v`: Variable to extract (required). Example: "Operative_Temperature", "Air_Temperature"
...
The consolidated CSV file has LONG format with three columns:

```csv
Date/Time;Zone;Variable_Value
01/01 01:00:00;1XPLANTA1:STUDYROOM;17.466152264563284
01/01 01:00:00;2XPLANTA2:STUDYROOM;17.397706170964163
01/01 02:00:00;1XPLANTA1:STUDYROOM;17.44304269739435
01/01 02:00:00;2XPLANTA2:STUDYROOM;17.298361645958487
...
```
...
- **Zone**: Zone name
- **Variable_Value**: Value of the specified variable (column name matches the variable)
...
```bash
# Consolidate operative temperature from all zones
energyplus-sim pivot --variable "Operative_Temperature"

# Consolidate relative humidity
energyplus-sim pivot --variable "Relative_Humidity"

# Consolidate with detailed summary
energyplus-sim pivot --variable "Air_Temperature" --summary

# Consolidate only STUDYROOM files
energyplus-sim pivot --variable "Operative_Temperature" --input "outputs/exports/*STUDYROOM*.csv"

# Consolidate with custom name
...
- **Flexible filtering**: Easy to filter by zone or time range
- **Scalability**: Works well with any number of zones

### Use Cases

- **Comparative analysis**: Compare operative temperature between different zones
- **Pattern identification**: Detect zones with similar thermal behavior
- **Temporal analysis**: Study evolution of variables over time
- **Model validation**: Verify consistency of results between zones
- **Reporting**: Generate consolidated reports for multiple spaces
